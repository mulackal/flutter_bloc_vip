...
class Device {
  ...
  factory Device.get() {
    ...
    if (devicePixelRatio < 2 && (width >= 1000 || height >= 1000)) {
      ...
      isTablet = true;
      isPhone = false;
      print("#########devicePixelRatio:tab1 $isTablet");
    }
    else if (devicePixelRatio == 2 && (width >= 1920 || height >= 1920)) {
      isTablet = true;
      isPhone = false;
      print("#########devicePixelRatio:tab2 $isTablet");
    }
    else {
      isTablet = false;
      isPhone = true;
      print("#########devicePixelRatio:tab-else $isTablet");
    ...
    if( isAndroid ){
      ...
      if( diagonalSizeInches >= 6.5 ){
        isTablet = true;
        isPhone = false;
        print("#########diagonalSizeInches:tab $isTablet");
      }
      else{
        isTablet = false;
        isPhone = true;
        print("#########diagonalSizeInches:tab-else $isTablet");
      }
    }
